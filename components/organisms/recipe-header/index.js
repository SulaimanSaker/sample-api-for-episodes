...
import { details } from "../recipe-content/data";
const RecipeHeader = () => {
  const images = details.headerImages;

  return (
    <Styles>
      <header className="recipe-header ">
        <div className="recipe-header__carousel">
          {images.length > 1 && (
        ...
        <div className="recipe-header__date">
          Last Updated{" "}
          <date className="last-updated">{moment(details?.publishDate).format()}</date>
        </div>

        <div className="recipe-header__svgs">
